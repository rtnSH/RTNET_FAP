...
- [x] Assignee candidates are limited to `admin`, `cmkim`, `ssjeon`, `sh.lee`
...
- [x] Assignee options are restricted to the approved four accounts only
...
- [x] `GET /api/create/options` responds with `projects`, `trackers`, `statuses`, `priorities`, `assignees`
